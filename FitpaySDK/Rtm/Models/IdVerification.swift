...
open class IdVerification: NSObject, Serializable {
    ...
    public required init(from decoder: Decoder) throws {
        ...
        lastOemAccountActivityDate = try container.decode(.lastOemAccountActivityDate, transformer: DateToIntTransform())
        deviceLostModeDate = try container.decode(.deviceLostModeDate, transformer: DateToIntTransform())
    ...
    public func encode(to encoder: Encoder) throws {
        ...
        try? container.encode(lastOemAccountActivityDate, forKey: .lastOemAccountActivityDate, transformer: DateToIntTransform())
