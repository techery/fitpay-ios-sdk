...
class ModelsParsingTests: XCTestCase {
    ...
    func testCreditCard() {
        ...
        XCTAssertEqual(creditCard?.state, TokenizationState(rawValue: "NOT_ELIGIBLE"))
    ...
    func testRtmConfig() {
        ...
        XCTAssertEqual(rtmConfig?.clientId, mockModels.someId)
        XCTAssertEqual(rtmConfig?.redirectUri, "https://api.fit-pay.com")
        XCTAssertEqual(rtmConfig?.userEmail, "someEmail")
        XCTAssertNotNil(rtmConfig?.deviceInfo)
        XCTAssertEqual(rtmConfig?.hasAccount, false)
        XCTAssertEqual(rtmConfig?.version, "2")
        XCTAssertEqual(rtmConfig?.demoMode, false)
        XCTAssertEqual(rtmConfig?.customCSSUrl, "https://api.fit-pay.com")
        XCTAssertEqual(rtmConfig?.demoCardGroup, "someGroup")
        XCTAssertEqual(rtmConfig?.accessToken, "someToken")
        XCTAssertEqual(rtmConfig?.language, "en")
        XCTAssertEqual(rtmConfig?.baseLanguageUrl, "https://api.fit-pay.com")
