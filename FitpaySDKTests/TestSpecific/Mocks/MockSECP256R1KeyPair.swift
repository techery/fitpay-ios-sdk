...
class MockSECP256R1KeyPair: SECP256R1KeyPair {
    ...
    // with unknown prefix
    var mocPublicKey: String? = "3059301306072a8648ce3d020106082a8648ce3d03010703420004b9e39c8a2af9ab895f976db545fdc25c49f134889d170e828e5bb5b3a7bb4350e810cf0d82ae904af6aca9410c72b1721cf0a57e4b330b69233fce3690c0eb8a"
    ...
    override func generateSecretForPublicKey(_ publicKey: String) -> Data? {
        ...
        let start = publicKey.index(self.publicKey!.startIndex, offsetBy: 0)
        let end   = publicKey.index(self.publicKey!.startIndex, offsetBy: unknownPrefix.count)
